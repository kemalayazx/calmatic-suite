    ...
    <div style={{ maxWidth: "48rem", margin: "0 auto", padding: "1.5rem 1rem" }}>
      ...
      <div style={{ background: "#0a0a0b", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1rem", marginBottom: "1.5rem" }}>
        <p style={{ fontSize: "0.75rem", color: "#52525b", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "0.75rem" }}>
          {t("timezone.label.liveWorldClock")}
        </p>
      ...
      <div style={{ background: "#111113", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1.5rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
          <div>
            <label style={{ fontSize: "0.8rem", color: "#a1a1aa", display: "block", marginBottom: "0.3rem" }}>{t("timezone.label.fromTimezone")}</label>
          ...
          <div>
            <label style={{ fontSize: "0.8rem", color: "#a1a1aa", display: "block", marginBottom: "0.3rem" }}>{t("timezone.label.toTimezone")}</label>
        ...
        <div style={{ marginBottom: "1rem" }}>
          <label style={{ fontSize: "0.8rem", color: "#a1a1aa", display: "block", marginBottom: "0.3rem" }}>{t("timezone.label.dateTime")}</label>
        ...
        >
          {t("timezone.btn.convert")}
        </button>

        {result && (
          <div style={{ background: "#0f172a", border: "1px solid #1e3a5f", borderRadius: "0.75rem", padding: "1rem 1.25rem", marginTop: "1rem" }}>
            <p style={{ fontSize: "0.8rem", color: "#64748b", marginBottom: "0.5rem" }}>{t("timezone.label.resultInTarget")}</p>
            ...
            <p style={{ fontSize: "0.9rem", color: result.diff > 0 ? "#86efac" : result.diff < 0 ? "#f87171" : "#a1a1aa" }}>
              {t("timezone.label.timeDifference")}: {fmtDiff(result.diff)}
            </p>
          </div>
        )}
      </div>
