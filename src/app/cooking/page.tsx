...
export default function CookingPage() {
  ...
  const tabs = ["Recipe Scaler", "Unit Conversion", "Baking Ratios"];
  ...
  return (
    <div style={{ maxWidth: "860px", margin: "0 auto" }}>
      <h1 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: "0.5rem" }}>Cooking Calculator</h1>
      <p style={{ color: "#71717a", marginBottom: "2rem" }}>Recipe scaler, unit converter, and baking ratios.</p>
      ...
      {activeTab === 0 && (
        <div>
          <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem", alignItems: "flex-end" }}>
            <div>
              <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>Original Servings</label>
            ...
            <div>
              <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>Target Servings</label>
            ...
            <div style={{ fontSize: "0.875rem", color: "#71717a", paddingBottom: "0.5rem" }}>
              Scale: <strong style={{ color: "#a78bfa" }}>×{(parseFloat(targetServings) / parseFloat(origServings) || 0).toFixed(3)}</strong>
            </div>
          </div>
          ...
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: "0.75rem", overflow: "hidden", marginBottom: "1rem" }}>
            <div style={{ display: "grid", gridTemplateColumns: "80px 90px 1fr 120px 32px", gap: "0.5rem", padding: "0.75rem 1.25rem", borderBottom: "1px solid #3f3f46" }}>
              <div style={{ fontSize: "0.75rem", color: "#71717a", fontWeight: 600 }}>Amount</div>
              <div style={{ fontSize: "0.75rem", color: "#71717a", fontWeight: 600 }}>Unit</div>
              <div style={{ fontSize: "0.75rem", color: "#71717a", fontWeight: 600 }}>Ingredient</div>
              <div style={{ fontSize: "0.75rem", color: "#71717a", fontWeight: 600 }}>Scaled</div>
              <div />
            </div>
      ...
      {activeTab === 1 && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}>
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1.5rem" }}>
            <div style={{ fontWeight: 700, color: "#a78bfa", marginBottom: "1.25rem" }}>Volume & Weight</div>
            <div style={{ marginBottom: "1rem" }}>
              <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>Value</label>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", marginBottom: "1.25rem" }}>
              <div>
                <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>From</label>
              ...
              <div>
                <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>To</label>
            ...
            <div style={{ padding: "0.875rem", background: "#09090b", borderRadius: "0.5rem", textAlign: "center" }}>
              {convResult !== null ? (
                ...
                <div style={{ color: "#71717a", fontSize: "0.875rem" }}>No direct conversion available between these units.</div>
              )}
          ...
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1.5rem" }}>
            <div style={{ fontWeight: 700, color: "#a78bfa", marginBottom: "1.25rem" }}>Temperature</div>
            <div style={{ marginBottom: "1rem" }}>
              <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>Temperature</label>
            ...
            <div style={{ marginTop: "1rem" }}>
              <div style={{ fontSize: "0.75rem", color: "#71717a", marginBottom: "0.5rem" }}>Common oven temps</div>
        ...
        <div>
          ...
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1.5rem" }}>
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              <label style={{ display: "block", color: "#a1a1aa", fontSize: "0.8rem", marginBottom: "0.3rem" }}>Flour Amount (g)</label>
